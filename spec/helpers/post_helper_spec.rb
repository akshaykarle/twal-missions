...
describe PostHelper do
  ...
  describe 'add_post_links' do
    ...
    context 'Twitter post' do
      context 'should render links for regular URLs, hashtag and username' do
        ...
        it { should include('<a target="_blank" href="http://www.imdb.com/title/tt0118688/"') }
      ...
      context 'should embed but not render link for videos' do
        ...
        it { should_not include('<a target="_blank" href="https://www.youtube.com/watch?v=q4tbZ7xnEjk"')}
        it { should_not include('<a target="_blank" href="https://vine.co/v/MI3PU9Ag9Wu"')}
        it { should include('<a target="_blank" href="http://twitter.com/hashtag/Friday"')}
      end
    end
    ...
    context 'Instagram post' do
      context 'should render links for regular URLs, hashtag and username' do
        ...
        it { should include('<a target="_blank" href="http://jackierobinsonwest.org/"') }
      ...
      context 'should embed but not render link for youtube' do
        ...
        it { should include('<a target="_blank" href="https://m.youtube.com/watch?v=Qi6wjbKMnRA"')}
  ...
  describe 'link_hashtags_twitter' do
    ...
    its([:text]) { should include('target="_blank" href="http://twitter.com/hashtag/gothamcity">#gothamcity</a>') }
    its([:text]) { should include('target="_blank" href="http://twitter.com/hashtag/gotham">#gotham</a>') }
  end

  describe 'link_urls' do
    context 'should embed URLs for Twitter posts' do
      subject { helper.link_urls twitter_post }
      it { should include('<a target="_blank" href="http://dccomics.com"') }
